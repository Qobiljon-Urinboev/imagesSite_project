...
/* harmony import */ var _modules_imgSize__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/imgSize */ "./src/js/modules/imgSize.js");
...
/* harmony import */ var _modules_filter__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/filter */ "./src/js/modules/filter.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_imgSize__WEBPACK_IMPORTED_MODULE_7__["default"])('.sizes-block');
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_8__["default"])('.accordion-heading', '.accordion-block');
  Object(_modules_burger__WEBPACK_IMPORTED_MODULE_9__["default"])('.burger-menu', '.burger');
  Object(_modules_filter__WEBPACK_IMPORTED_MODULE_10__["default"])();
...
var accordion = function accordion(selector, itemsSelector) {
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFunc = function calcFunc() {
    ...
    if (sizeBlock.value == '' || materialBlock.value == "") {
      resultBlock.textContent = "please, select size and image";
...
var filter = function filter() {
  ...
  var btnGrandded = menu.querySelector('.granddad');
  ...
  var clickBtn = function clickBtn(btn, btnAll) {
    btn.addEventListener('click', function () {
      typeFilter(btnAll);
    });
  };
...
var imgSize = function imgSize(imgSelector) {
  var blocks = document.querySelectorAll(imgSelector);

  function showImg(block) {
    var img = block.querySelector('img');
    img.src = img.src.slice(0, -4) + '-1.png';
    block.querySelectorAll('p:not(.sizes-hit)').forEach(function (element) {
...
/* harmony default export */ __webpack_exports__["default"] = (imgSize);
...
var slider = function slider(slides, dir, prev, next) {
  ...
  var paused = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : false;
